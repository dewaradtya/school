...
import { TypeInputWithIcon } from '../../components/Forms/TypeInput';
...
const SignIn = () => {
  ...
  const handleSubmit = (e) => {
    ...
    AxiosClient.get('/sanctum/csrf-cookie').then((response) => {
      AxiosClient.post('/api/login', formValues).then((res) => {
        toast.success(res.data.message, { id: toastId })
        navigate('/')
      }).catch((err) => {
        console.log(err)
        toast.error(err.response.data.message, { id: toastId, duration: 5000 })
  ...
  return (
    <div className="flex items-center h-screen p-4 md:p-6 2xl:p-10">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  <TypeInputWithIcon type="email" icon={<FaRegEnvelope />} label="Email" id="email" value={formValues.email} onChange={(e) => handleChange('email', e.target.value)} placeholder="Enter your email" disabled={isLoading} />
                </div>
